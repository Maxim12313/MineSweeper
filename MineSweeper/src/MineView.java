...
class MineView
{
    ...
    private int defaultNumMines = 10;
            ...
            else
            {
                ...
                if (debug && !cell.isVisible())
                    ...
                    if (cell.getNeighborMines()==0){
                        pen.setColor(Color.WHITE);
                    } else if (cell.getNeighborMines()==1){
                        pen.setColor(Color.yellow);
                    } else if (cell.getNeighborMines()==2){
                        pen.setColor(Color.orange);
                    } else if (cell.getNeighborMines()==3){
                        pen.setColor(Color.red);
                    } else if (cell.getNeighborMines()==4){
                        pen.setColor(Color.magenta);
                    } else if (cell.getNeighborMines()==5){
                        pen.setColor(Color.pink);
                    } else if (cell.getNeighborMines()==6){
                        pen.setColor(Color.cyan);
                    } else if (cell.getNeighborMines()==7){
                        pen.setColor(Color.GRAY);
                    } else if (cell.getNeighborMines()==8){
